  ...
  return (
    ...
    >
      ...
      <Link
        href={
          isAgent
            ? 'https://lumination.ai/docs/dev/http_api_reference#create-session-with-agent'
            : 'https://lumination.ai/docs/dev/http_api_reference#create-session-with-chat-assistant'
        }
        target="_blank"
      >
